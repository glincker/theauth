...
A Hono server scaffolded with [KavachOS](https://kavachos.com). Runs as an MCP OAuth 2.1 authorization server and a resource server in one process.

## What's included

- **Hono 4** on Node.js
- **KavachOS** for agent identity, session management, and the MCP OAuth 2.1 stack
...
|-------------------|----------|----------------------------------------------------------------------------|
| `KAVACHOS_SECRET` | Yes      | Long random string. Signs sessions and access tokens.                      |
