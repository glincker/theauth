...
No extra configuration is needed, ephemeral sessions are part of the `theauth` core package and share the same database as the rest of TheAuth.

```typescript
import { createKavach } from 'theauth';
import { createEphemeralSessionModule } from 'theauth/auth';
