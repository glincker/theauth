...
import { createHibpModule } from '@glinr/theauth/modules/hibp'; // [!code highlight]
...
// Throws AuthError with code PASSWORD_BREACHED if compromised
...
<CardGroup cols={2}>
  ...
  <Card title="Email and password" href="/auth/email-password" icon="envelope">
    The primary auth plugin that integrates with HIBP enforcement.
  </Card>
