...
<CardGroup cols={2}>
  ...
  <Card title="KavachOS vs Casdoor" href="/compare/vs-casdoor" icon="server">
    KavachOS as a library versus Casdoor as a standalone Go service.
  </Card>
  <Card title="Passkey" href="/auth/passkey" icon="fingerprint">
    WebAuthn / FIDO2 support in KavachOS.
  </Card>
  <Card title="Agent identity" href="/agents" icon="robot">
    What KavachOS adds beyond passkey auth for the agent layer.
  </Card>
</CardGroup>
