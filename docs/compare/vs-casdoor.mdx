...
description: KavachOS as an in-process TypeScript library versus Casdoor as a standalone Go IAM service. Compares MCP OAuth 2.1, agent identity, LDAP, RBAC, and deployment model.
icon: server
---
...
<CardGroup cols={2}>
  <Card title="KavachOS vs better-auth" href="/compare/vs-ba" icon="code-compare">
    How KavachOS compares to the TypeScript-native auth library.
  </Card>
  <Card title="KavachOS vs Hanko" href="/compare/vs-hanko" icon="fingerprint">
    KavachOS versus the passkey-first Go auth library.
  </Card>
  <Card title="MCP OAuth 2.1" href="/mcp" icon="globe">
    How KavachOS implements the MCP authorization server spec.
  </Card>
