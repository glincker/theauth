---
title: UI components
description: Drop-in React components for sign-in, sign-up, password reset, 2FA, and OAuth buttons from @kavachos/ui. Tailwind-based, wired to KavachProvider automatically.
icon: table-columns
---
...
<Info>
  Components require `@kavachos/react` to be installed and a `KavachProvider` wrapping your app. See the [React hooks](/react) page for provider setup.
</Info>
...
<ParamField path="basePath" type="string" default="&quot;/api/kavach&quot;">Must match your KavachOS API route.</ParamField>
