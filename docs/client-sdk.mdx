...
description: Issue HTTP calls to TheAuth from any runtime via `createKavachClient`. Covers agents, authorization, delegations, audit logs, and MCP registration.
icon: code
---
...
```typescript
import { KavachApiError } from '@glinr/theauth-client';
