...
`@theauth/client` is a typed HTTP client for the TheAuth REST API. It covers agents, authorization, delegations, audit logs, and MCP server registration.
...
```typescript
import { KavachApiError } from '@theauth/client';
