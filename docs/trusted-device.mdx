...
import { twoFactor } from 'theauth/auth';
import { createTrustedDeviceModule } from 'theauth/modules/trusted-device'; // [!code highlight]
...
<CardGroup cols={2}>
  <Card title="Two-factor auth" href="/auth/two-factor" icon="mobile-screen">
    TOTP plugin that trusted devices integrate with to skip the 2FA step.
  </Card>
