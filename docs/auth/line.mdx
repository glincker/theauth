---
title: LINE
description: Authenticate users via LINE OAuth 2.0 with `lineProvider()`. Create a LINE Login channel and configure `openid`, `profile`, and `email` scopes.
icon: "/brand-icons/line.svg"
---
...
import { lineProvider } from 'theauth/auth';
