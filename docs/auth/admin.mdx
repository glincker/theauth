---
title: Admin
description: "Manage users with `kavach.admin`: list accounts, apply permanent or time-limited bans, impersonate for support debugging, and delete user data on request."
icon: gear
---

## Setup

Pass `adminUserIds` when creating your TheAuth instance:
