---
title: Auth0
description: Authenticate users via Auth0 OIDC with `auth0Provider`. Pass your tenant domain and client credentials to attach Auth0-issued tokens to a TheAuth session.
icon: "/brand-icons/auth0.svg"
---
...
import { oauth, auth0Provider } from '@glinr/theauth/auth';
