---
title: Kakao
description: Authenticate users via Kakao OAuth 2.0. Covers app creation, Kakao Login activation, redirect URI, and `profile_nickname` and `account_email` scopes.
icon: "/brand-icons/kakaotalk.svg"
---
