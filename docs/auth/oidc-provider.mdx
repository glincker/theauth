---
title: "OIDC provider"
description: "`createOidcProviderModule()` turns KavachOS into an OpenID Connect provider. Covers RS256 key setup, client registration, PKCE, and JWKS endpoint."
icon: key
---
...
<CardGroup cols={2}>
  <Card title="OAuth overview" href="/auth/oauth" icon="lock">
    Using KavachOS as an OAuth client to sign in via other providers.
  </Card>
