---
title: Okta
description: Authenticate users via Okta OpenID Connect with `oktaProvider()`. Create an OIDC web app in the Okta Admin Console, copy your domain, and configure the provider.
icon: "/brand-icons/okta.svg"
---
...
import { oauth, oktaProvider } from '@glinr/theauth/auth';
