...
import { emailPassword } from '@glinr/theauth/auth'; // [!code highlight]
...
The plugin registers endpoints automatically. You still need to route incoming requests to TheAuth from your framework adapter.
...
<CardGroup cols={2}>
  ...
  <Card title="Passkey" href="/auth/passkey" icon="fingerprint">
    WebAuthn biometric auth that can replace passwords entirely.
  </Card>
