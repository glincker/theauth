...
import { deviceAuth } from '@glinr/theauth/auth'; // [!code highlight]
...
<CardGroup cols={2}>
  ...
  <Card title="Magic link" href="/auth/magic-link" icon="link">
    Another passwordless flow for devices that can open a browser.
  </Card>
  <Card title="Sessions" href="/sessions" icon="clock">
    How TheAuth manages session lifetime after device authorization.
  </Card>
  <Card title="MCP" href="/mcp" icon="plug">
    OAuth 2.1 flows for agent-to-tool authentication.
  </Card>
</CardGroup>
