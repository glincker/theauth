---
title: Linear
description: Authenticate users via Linear OAuth 2.0. Register an OAuth application, configure the `linear` provider, and request `read` or `write` scopes as needed.
icon: "/brand-icons/linear.svg"
---
