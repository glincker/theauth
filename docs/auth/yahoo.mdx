...
iconType: brands
title: Yahoo
description: Authenticate users with Yahoo via `yahooProvider`. Covers Developer Console app creation, OpenID Connect API enablement, and email and profile scopes.
---
...
import { oauth, yahooProvider } from '@glinr/theauth/auth';
