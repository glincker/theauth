...
iconType: brands
title: Microsoft
description: Authenticate users via Microsoft Entra ID OAuth 2.0. Covers app registration, tenant configuration for personal or work accounts, and the `microsoft` provider.
---
...
- **Redirect URI**: Web, `https://auth.example.com/auth/oauth/callback/microsoft`
...
<CardGroup cols={2}>
  ...
  <Card title="SSO" href="/auth/sso" icon="shield-halved">
    SAML 2.0 and OIDC enterprise SSO, including Azure AD.
  </Card>
  <Card title="Google" href="/auth/google" icon="google">
    Sign in with Google for personal and workspace accounts.
  </Card>
