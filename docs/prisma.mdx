...
description: Query every KavachOS table through an existing PrismaClient via @kavachos/prisma. Supports Prisma transactions without requiring Drizzle as a second ORM client.
icon: database
---
