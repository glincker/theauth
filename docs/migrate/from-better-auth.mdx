...
description: Switch a better-auth app to KavachOS. Maps betterAuth config, plugins, session types, and client hooks to KavachOS equivalents with before and after diffs.
...
<CardGroup cols={2}>
  ...
  <Card title="Database setup" href="/database" icon="database">
    Configure the Drizzle-based database layer KavachOS uses.
  </Card>
  <Card title="Prisma adapter" href="/prisma" icon="database">
    Query KavachOS tables from an existing PrismaClient.
  </Card>
