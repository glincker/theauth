...
import { createAuthClient } from '@glinr/theauth-client';
...
No. MCP OAuth 2.1 is built into TheAuth core. Pass a `mcp` config block to `createAuth` and enable it in your adapter.
