...
| `<ClerkProvider>` | `<KavachProvider>` from `@theauth/react` |
| `useUser()` | `useUser()` from `@theauth/react` |
| `useAuth()` | `useSession()` + `useSignOut()` from `@theauth/react` |
| `useSession()` | `useSession()` from `@theauth/react` |
| `useSignIn()`, `useSignUp()` | `useSignIn()`, `useSignUp()` from `@theauth/react` |
...
import { organization } from 'theauth/plugins';
