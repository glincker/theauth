...
description: Move a Clerk app to KavachOS. Maps ClerkProvider, clerkMiddleware, useAuth, and Organizations to KavachOS, with Next.js middleware sample and data export steps.
...
<CardGroup cols={2}>
  <Card title="KavachOS vs paid platforms" href="/compare/vs-paid" icon="building">
    Structural comparison of KavachOS versus Clerk and Auth0.
  </Card>
