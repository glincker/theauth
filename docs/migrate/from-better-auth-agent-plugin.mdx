...
description: Switch from @better-auth/agent-auth to KavachOS AgentIdentity. Maps scopes to Permission objects and delegation chains, with cascading revocation support.
