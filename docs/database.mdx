...
<Tabs>
  <Tab title="SQLite">
    SQLite is the default for development. No peer dependencies beyond `better-sqlite3`, which ships with `theauth`.
...
<CardGroup cols={2}>
  ...
  <Card title="Configuration" href="/configuration" icon="sliders">
    Full createKavach() options including database and secrets.
  </Card>
