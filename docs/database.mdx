...
description: Configure KavachOS with SQLite, Postgres, MySQL, or Cloudflare D1. Covers connection setup, migration, WAL mode for SQLite, and skipping auto-migrations.
icon: database
---
...
<CardGroup cols={2}>
  <Card title="Prisma adapter" href="/prisma" icon="database">
    Query KavachOS tables through an existing PrismaClient.
  </Card>
