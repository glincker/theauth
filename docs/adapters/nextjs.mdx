---
title: Next.js
description: Mount KavachOS auth routes in Next.js with `kavachNextjs(kavach)`. Drop into a catch-all App Router file for agent identity, delegation, and MCP OAuth 2.1 endpoints.
