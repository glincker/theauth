---
title: SvelteKit
description: Mount KavachOS auth routes in SvelteKit with `kavachSvelteKit(kavach)`. Returns named server route handlers, fully edge-compatible with no conversion layer.
