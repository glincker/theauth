---
title: Nuxt
description: Mount KavachOS auth routes in Nuxt with `kavachNuxt(kavach)`. Returns an H3 EventHandler for a catch-all server route, covering agent identity and OAuth.
