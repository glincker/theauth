---
title: Nuxt
description: Mount TheAuth auth routes in Nuxt with `authNuxt(kavach)`. Returns an H3 EventHandler for a catch-all server route, covering agent identity and OAuth.
