...
description: Issue and verify short-lived federation tokens so an AgentIdentity can authenticate at a remote KavachOS instance without re-registration or shared databases.
icon: network-wired
---
...
<CardGroup cols={2}>
  ...
  <Card title="Delegation" href="/delegation" icon="link">
    Delegate permissions within a single KavachOS instance.
  </Card>
