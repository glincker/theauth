...
description: Embed `KavachDashboard` from `@theauth/dashboard` to manage agents, permissions, delegation chains, and audit logs. Runs standalone via `npx theauth dashboard`.
icon: table-columns
---
...
1. A React component (`@theauth/dashboard`) you embed in an existing app
