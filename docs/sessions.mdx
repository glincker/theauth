...
import { createCookieSessionManager } from 'theauth/auth'; // [!code highlight]
...
```typescript title="lib/kavach.ts"
import { createJwtSessionModule } from 'theauth/auth'; // [!code highlight]
...
import { createSessionFreshnessModule } from 'theauth'; // [!code highlight]
...
import { generateCsrfToken, validateCsrfToken, validateOrigin } from 'theauth'; // [!code highlight]
