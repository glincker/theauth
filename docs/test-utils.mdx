...
description: Test auth-dependent code without a database using @kavachos/test-utils. Provides entity factories, in-memory mock auth server, and per-request user overrides.
icon: code
---
