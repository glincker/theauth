---
title: Svelte
description: Add KavachOS auth to Svelte and SvelteKit apps via createKavachClient and createKavachHooks. Session state is reactive and server-populated on first page load.
icon: code
---
...
<CardGroup cols={2}>
  <Card title="SvelteKit adapter" href="/adapters/sveltekit" icon="code">
    Server-side KavachOS handler for SvelteKit routes and hooks.
  </Card>
