...
<Info>
`createAuth` is async when using D1. Workers and Deno both support top-level await, so you can also initialize outside the handler if you use a module worker.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Configuration" icon="gear" href="/configuration">
    All `createAuth()` options and environment patterns.
  </Card>
</CardGroup>
